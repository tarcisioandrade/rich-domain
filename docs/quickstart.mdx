...
keywords: ["quickstart","getting-started","tutorial","setup","installation","ddd","typescript","guide"]
---
...
class Product extends Aggregate<ProductProps> {
  ...
  protected static hooks: EntityHooks<ProductProps, Product> = {
    // Runs before create entity (Props is a plain object);
    onBeforeCreate: (props) => {
      console.log('Props to create entity', { props })
    }
