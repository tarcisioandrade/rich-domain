...
```bash npm
npm install @woltz/rich-domain-typeorm typeorm reflect-metadata
```

```bash pnpm
pnpm add @woltz/rich-domain-typeorm typeorm reflect-metadata
```

```bash yarn
yarn add @woltz/rich-domain-typeorm typeorm reflect-metadata
```
