...
<CardGroup cols={2}>
  <Card title="Consistency Boundary" icon="shield">
    All invariants within an Aggregate are enforced immediately. Changes to
    other Aggregates are eventually consistent.
  </Card>
  <Card title="Single Unit of Persistence" icon="database">
    Aggregates are loaded and saved as a whole. Repositories work with
  ...
  <Card title="Encapsulation" icon="lock">
    External objects can only reference the Aggregate root, never internal
    entities directly.
  </Card>
</CardGroup>
