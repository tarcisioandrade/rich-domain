...
- 1faca51: Fix native ESM runtime compatibility by emitting resolvable `.js` relative specifiers and avoiding an ESM initialization cycle in change tracking.
