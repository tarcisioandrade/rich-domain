...
keywords: ["id","identity","uuid","identifier","primary-key","ddd","typescript"]
---
...
| `markAsNotNew()`   | `void`    | Marks the Id as not new (after persisting)      |
| `markAsNew()`      | `void`    | Marks the Id as new                             |
