...
<Note>
  For a complete working example, see the [fastify-with-typeorm
  example](https://github.com/tarcisioandrade/rich-domain/tree/main/examples/backend/fastify-with-typeorm)
  in the repository.
</Note>
